...
@click.option('--loss_threshold', type=float, default=0.1, help='Early stopping threshold for inversion. Empirically selected per video.')
...
def _main(savepoint_path,
    ...
    # loading previous inversion results
    ...
    print(f'*******************************************************************************')
    print(f'Optimizing inset{angle_prefix}...')
    ...
    fname = f'{vid.get_video_title()}_inset{angle_prefix}{edit_description}'
